...
Deno.serve(async (request) => {
  ...
  try {
    ...
    const detailRows = [
      ...
      .map(([label, value]) => `<tr><td style="padding:7px 12px 7px 0;color:#9ea89f"><strong>${esc(label)}</strong></td><td style="padding:7px 0;color:#f2f2f2">${esc(value)}</td></tr>`)
      .join('');

    const adminSubject = `Hlonyane enquiry — ${reference}`;
    const adminHtml = `
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#000000" style="width:100%;background:#000000;margin:0;padding:0">
        <tr><td align="center" bgcolor="#000000" style="padding:32px 16px;background:#000000">
          <table role="presentation" width="680" cellspacing="0" cellpadding="0" border="0" bgcolor="#000000" style="width:100%;max-width:680px;background:#000000;border-collapse:separate;border-spacing:0;border-radius:18px;overflow:hidden">
            ...
            <tr><td style="padding:34px 40px 18px">
              <h2 style="margin:0 0 22px;font-family:Arial,sans-serif;font-size:26px;line-height:1.25;color:#4fa85d">New Hlonyane Residential enquiry</h2>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;width:100%;font-family:Arial,sans-serif;font-size:15px;color:#f2f2f2">${detailRows}</table>
              <div style="margin-top:24px;padding:18px 20px;background:#111111;border-left:4px solid #c9a84b;font-family:Arial,sans-serif;font-size:15px;line-height:1.6;color:#f2f2f2">
                ${esc(message).replace(/\n/g, '<br>')}
              </div>
              <p style="margin:22px 0 0;font-family:Arial,sans-serif;color:#aeb5ae;font-size:12px;line-height:1.5">Sent from the Hlonyane Residential website.</p>
            </td></tr>
          </table>
        </td></tr>
      </table>`;
    ...
    if (sendConfirmation) {
      ...
      const confirmationHtml = `
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#000000" style="width:100%;background:#000000;margin:0;padding:0">
          <tr><td align="center" bgcolor="#000000" style="padding:36px 14px;background:#000000">
            <table role="presentation" width="680" cellspacing="0" cellpadding="0" border="0" bgcolor="#000000" style="width:100%;max-width:680px;background:#000000;border-collapse:separate;border-spacing:0;border-radius:20px;overflow:hidden;border:1px solid #202020">
              ...
              <tr><td style="padding:38px 40px 18px">
                <h1 style="margin:0 0 24px;font-family:Arial,sans-serif;font-size:31px;line-height:1.25;color:#4fa85d;font-weight:700">Thank you for contacting Hlonyane Residential</h1>
                ...
                <p style="margin:0 0 18px;font-family:Arial,sans-serif;font-size:18px;line-height:1.6;color:#f2f2f2">Hi ${esc(name)},</p>
                <p style="margin:0 0 22px;font-family:Arial,sans-serif;font-size:17px;line-height:1.65;color:#f2f2f2">Your enquiry has been received successfully by Hlonyane Residential.</p>

                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#111111" style="width:100%;background:#111111;border-collapse:separate;border-spacing:0;border-radius:10px;margin:0 0 24px">
                  <tr><td style="padding:18px 20px;font-family:Arial,sans-serif">
                    ...
                    <div style="font-size:22px;line-height:1.35;font-weight:700;color:#ffffff">${reference}</div>
                  </td></tr>
                </table>

                <p style="margin:0 0 18px;font-family:Arial,sans-serif;font-size:17px;line-height:1.65;color:#f2f2f2">A member of the Hlonyane Residential team will be in touch.</p>
                <p style="margin:0 0 28px;font-family:Arial,sans-serif;font-size:14px;line-height:1.6;color:#aeb5ae">Please keep the reference number above should you need to follow up on your enquiry.</p>

                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#111111" style="width:100%;background:#111111;border-collapse:separate;border-spacing:0;margin:0 0 28px;border-left:4px solid #c9a84b">
                  <tr><td style="padding:16px 18px;font-family:Arial,sans-serif;font-size:15px;line-height:1.6;color:#f2f2f2">${esc(message).replace(/\n/g, '<br>')}</td></tr>
                </table>
